  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
   ...
   ?>
    ...
    <div class="row" id="coursesContainer">
      ...
      <div class="col-md-4 mb-4 course-card" data-category="web">
        <div class="card shadow-sm">
          <div class="card-body">
            ...
            <p class="card-text">Learn the fundamentals of building web pages with HTML and CSS.</p>
      ...
      <!-- Course Card 2 -->
      <div class="col-md-4 mb-4 course-card" data-category="data">
        <div class="card shadow-sm">
          <div class="card-body">
            <h5 class="card-title">Python for Data Science</h5>
            <p class="card-text">Master Python programming to analyze and visualize data.</p>
      ...
      <!-- Course Card 3 -->
      <div class="col-md-4 mb-4 course-card" data-category="design">
        <div class="card shadow-sm">
          <div class="card-body">
            <h5 class="card-title">UI/UX Design Principles</h5>
            <p class="card-text">Understand the basics of designing user-friendly interfaces.</p>
      ...
      <div class="col-md-4 mb-4 course-card" data-category="web">
        <div class="card shadow-sm">
          <div class="card-body">
            ...
            <p class="card-text">Get started with JavaScript to create dynamic web pages.</p>
